...
\textit{Corporate Sustainability Reporting Directive} (CSRD), y con ella se abrió una de
las transformaciones más profundas que ha vivido la información corporativa europea en las
últimas décadas. Su efecto práctico, sin embargo, no se ha percibido hasta hace muy poco:
...
ganado un peso difícil de exagerar. Inversores institucionales, supervisores y consumidores
...
se han convertido en una preocupación regulatoria y académica de primer orden
...
\bigskip
En definitiva, este trabajo se justifica por su oportunidad temporal —captura el momento
...
La elección de delimitar con precisión estos objetivos no es casual: las conclusiones del
...
Conviene subrayar, por último, una decisión metodológica que recorre todo el trabajo y que ya
