...
No obstante, ese marco normativo ha sido cambiante desde su entrada en vigor.
A principios de 2025, la Comisión Europea presentó el denominado \textit{Paquete Ómnibus}, un
conjunto de medidas legislativas orientadas a simplificar las obligaciones de sostenibilidad
empresarial. La primera medida aprobada conocida como \textit{Stop the Clock} pospuso dos años la obligación de reporte para las empresas de
segunda oleada, esto es, las grandes compañías no previamente sujetas a la NFRD
\parencite{omnibus2025}. Esto impacta directamente en el análisis, es necesario centrarse en las empresas que si fueron afectadas por dichas medidas.
La segunda, la Directiva (UE) 2026/470, elevó sustancialmente los
umbrales de aplicación de la CSRD: quedan obligadas únicamente las empresas que superen
simultáneamente los 1.000 empleados y los 450 millones de euros de facturación neta, lo que
excluye a cerca del 80\,\% de las entidades inicialmente previstas \parencite{omnibus2026}.
Por lo tanto, cualquier análisis que quiera estudiar este fenómeno debe centrarse en empresas que
pertenezcan al primer grupo (grandes empresas de interés público
sujetas ya a la NFRD), ya que sus obligaciones de reporte correspondientes al ejercicio
2024 no se ven alteradas.

Todo esto se produce en un contexto en el que la información no financiera ha
...
era, para mí, la mejor manera de acabar mi carrera, poniendo a trabajar juntas las dos cosas que más me interesan.
...
Por último, cabe resaltar que el análisis prescinde por completo de
